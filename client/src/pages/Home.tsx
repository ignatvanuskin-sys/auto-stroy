          ...
          <div className="mx-auto grid max-w-[1360px] gap-10 lg:grid-cols-[1fr_1.25fr]">
            ...
            <div className="grid gap-px bg-[#18201f]/15 sm:grid-cols-2">
              {[
                ...
                <div key={title as string} className="bg-[#f5f3ed] p-6">
                  <Icon className="text-[#bc5c35]" size={22} />
          ...
          <div className="mx-auto max-w-[1360px]">
            ...
            <div className="mt-12 grid gap-4 lg:grid-cols-3">
              {[
                ...
                <div
                  key={title}
                  className={`min-h-[300px] border p-7 ${i === 1 ? "border-[#bc5c35] bg-[#202a28] text-white" : "border-[#18201f]/15 bg-[#f8f6f0]"}`}
                >
                  <span
          ...
          <div className="mx-auto max-w-[1360px]">
            ...
            <div className="mt-14 grid gap-7 md:grid-cols-4">
              {process.map(([no, title, text]) => (
                <div key={no} className="border-t border-white/20 pt-5">
