...
export const leadStatusValues = ["New", "Qualified", "Contacted", "Site Visit", "Estimate Sent", "Proposal Sent", "Negotiation", "Won", "Lost"] as const;
...
export const users = mysqlTable("users", {
  ...
  crmRole: mysqlEnum("crmRole", ["owner", "manager", "analyst"]).default("manager").notNull(),
...
export const rateTables = mysqlTable("rateTables", {
  ...
  finishTier: mysqlEnum("finishTier", ["economy", "standard", "premium"]).notNull(),
...
export const leads = mysqlTable("leads", {
  ...
  preferredChannel: varchar("preferredChannel", { length: 30 }).notNull().default("Звонок"),
  region: varchar("region", { length: 80 }).notNull(),
  ...
  aiIntent: mysqlEnum("aiIntent", ["genuine_buyer", "researcher", "competitor_or_spam", "unclear"]),
  ...
  scoreBand: mysqlEnum("scoreBand", ["cold", "warm", "hot", "very_hot"]).notNull().default("cold"),
...
export const proposals = mysqlTable("proposals", {
  ...
  pdfUrl: text("pdfUrl"),
  status: mysqlEnum("status", ["draft", "sent", "viewed"]).notNull().default("draft"),
...
export const followups = mysqlTable("followups", {
  ...
  status: mysqlEnum("status", ["pending", "approved", "sent", "skipped", "cancelled"]).notNull().default("pending"),
